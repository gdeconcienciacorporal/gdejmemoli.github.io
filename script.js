...
const dataLine1 = {
  labels: ['Día 1', 'Día 2', 'Día 3', 'Dia 4'], // Etiquetas de los días
  datasets: [{
    label: 'Km recorridos en Semana 13',
    data: [5, 4, 80, 11], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [13, 24, 18, 15], // Datos de los km recorridos en cada día
